...
class DetailMealScreen extends StatelessWidget {
  ...
  /**
   * membuat function untuk menambahkan ke favoritenya . yang fungsi dari functionnya ini sama dengan function
   * tooglefav dan is Fav di main.dart
    */
  ...
  Widget build(BuildContext context) {
    ...
    //buat var untuk menentukan id yang di select/ yang dipilih
